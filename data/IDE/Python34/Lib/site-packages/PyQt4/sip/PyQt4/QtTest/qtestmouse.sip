// qtestmouse.sip generated by MetaSIP on Thu Sep 11 18:39:25 2014
//
...
%If (Qt_4_8_0 -)
    void mouseEvent(QTest::MouseAction action, QWidget *widget, Qt::MouseButton button, Qt::KeyboardModifiers stateKey, QPoint pos, int delay = -1);
%End
%If (Qt_5_0_0 -)
    void waitForEvents();
%End
