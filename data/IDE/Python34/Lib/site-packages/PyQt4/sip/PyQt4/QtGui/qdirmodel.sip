// qdirmodel.sip generated by MetaSIP on Thu Sep 11 18:39:23 2014
//
...
public:
    ...
    QDirModel(const QStringList &nameFilters, QFlags<QDir::Filter> filters, QFlags<QDir::SortFlag> sort, QObject *parent /TransferThis/ = 0);
