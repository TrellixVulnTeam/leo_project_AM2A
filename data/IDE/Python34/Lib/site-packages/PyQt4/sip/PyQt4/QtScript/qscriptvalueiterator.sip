// qscriptvalueiterator.sip generated by MetaSIP on Thu Sep 11 18:39:25 2014
//
...
public:
    ...
    QFlags<QScriptValue::PropertyFlag> flags() const;
    void remove();
    void toFront();
    void toBack();
%If (Qt_4_4_0 -)
...
private:
    QScriptValueIterator(const QScriptValueIterator &);
};
